CLASS /lrn/cl_s4d400_btd_data_obj DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS /LRN/CL_S4D400_BTD_DATA_OBJ IMPLEMENTATION.
...
**********************************************************************
    ...
    "Uncomment these lines to see syntax error ( VALUE is mandatory)
*  constants c_text2   type string.
*  constants c_number2 type i.
